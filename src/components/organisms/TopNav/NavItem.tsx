...
const NavItem = (props) => {
    ...
    return (
        ...
        >
            <div data-name={ToSnakeCase(props.navItem)}
                className={`flex justify-center items-center py-1 px-5 min-w-[100px] w-fit gap-3 rounded-md mobile:pl-0 cursor-pointer ${props.active ? 'bg-slate-400 text-white hover:bg-slate-500 ' : 'bg-slate-100 text-slate-500 hover:bg-slate-300'} ${props.style}`}
