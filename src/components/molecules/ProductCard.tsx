...
const ProductCard = (props) => {
    ...
    return (
        <div className={`${props.darkMode ? 'bg-Primary_700' : 'shadow-[0_8px_30px_rgb(0,0,0,0.12)]'} relative flex flex-col gap-5 p-5 mx-auto rounded-lg w-full h-fit min-w-[182px] max-w-lg`}>
            {props.quantity === 0 &&
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex justify-between items-center gap-2'>
                        ...
                        <div className='flex justify-end gap-2'>
                            <p className='font-bold text-right text-xl text-Primary'>
