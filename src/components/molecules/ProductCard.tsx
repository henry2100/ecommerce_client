    ...
    return (
        <div className={`${props.darkMode ? 'bg-Primary_700' : 'border'} relative flex flex-col mobile:gap-2 mx-auto rounded-lg w-full h-fit min-w-[182px] max-w-lg`}>
            ...
            <div className='overflow-hidden w-full h-64 rounded-t-lg bg-BackDrop_d_xs'>
                <img src={props.productImg[0] !== '' ? props.productImg[props.productImg.length - 1] : product_placeholder} alt="product_placeholder" className='w-full h-full object-cover cursor-pointer hover:scale-110 transition ease-in duration-250' onClick={handleRedirect}/>
            </div>
